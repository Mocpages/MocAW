...
public class BlockBuilding extends Block implements IRotatableBlock
{

IconRotationMap iconMap = new IconRotationMap();

public BlockBuilding(String regName)
  {
  super(Material.rock);
...
@Override
public BlockBuilding setIcon(RelativeSide side, String texName)
  {
