...
public class ContainerCreative extends ContainerBase
{
...
public ContainerCreative(EntityPlayer player, int x, int y, int z)
  {
  super(player, x, y, z);
  
  //ItemStack stack = player.getCurrentEquippedItem();
  //backpackSlotIndex = player.inventory.currentItem;
  WorkSiteQuarry q = (WorkSiteQuarry)player.worldObj.getTileEntity(x, y, z);
  //inventory = q.creativeInventory;
  int xPos, yPos;
